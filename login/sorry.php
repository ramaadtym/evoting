...
<html lang="en">
  <head>
    ...
    <title>Survey Quick Count IKA FH UNPAD</title>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              <h2 class="templatemo-inline-block">Mohon Maaf,</h2><hr>
              <p>Akun Anda belum diverifikasi. Silakan Periksa Folder <strong> Inbox/Junk/Spam</strong> pada E-mail Anda. Apabila dalam waktu 3 hari akun Anda belum diverifikasi, silakan hubungi kami melalui kontak berikut:</p>
              <ol>  
              	<li>Hotline: 081296055193</li>
                <li>E-mail: <a href="mailto:ikafhunpad@gmail.com">ikafhunpad@gmail.com</a></li>
              </ol>            
            </div>
